...
<div class="min-h-screen bg-midnight-950 flex items-center justify-center px-4">
	<div class="w-full max-w-md">
		...
		<div class="text-center mb-8">
			<div class="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-gold-500 to-gold-600 shadow-lg shadow-gold-500/20 mb-4">
				<IconTrendingUp class="h-8 w-8 text-midnight-950" />
			</div>
			...
			{#if form?.success}
				...
				<div class="text-center">
					<div class="inline-flex h-16 w-16 items-center justify-center rounded-full bg-green-500/20 mb-4">
						<IconCheck class="h-8 w-8 text-green-400" />
					</div>
			...
			{:else if !data.hasRecoveryKey}
				...
				<div class="text-center">
					<div class="inline-flex h-16 w-16 items-center justify-center rounded-full bg-yellow-500/20 mb-4">
						<IconAlertTriangle class="h-8 w-8 text-yellow-400" />
					</div>
