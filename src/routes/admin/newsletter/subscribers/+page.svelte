<script lang="ts">
	...
	const statusFilters = [
		...
		{ value: 'unsubscribed', label: 'Unsubscribed', icon: IconCircleX },
		{ value: 'bounced', label: 'Bounced', icon: IconAlertCircle }
	];
							...
							<tr class="hover:bg-midnight-800/30 transition-colors">
								...
								<td class="px-4 py-4 text-center">
									<span class="inline-flex items-center gap-1 text-sm text-midnight-300">
										<IconEye class="h-3 w-3 text-midnight-500" />
										{subscriber.totalOpens || 0}
									</span>
								</td>
								<td class="px-4 py-4 text-center">
									<span class="inline-flex items-center gap-1 text-sm text-midnight-300">
										<IconMouse class="h-3 w-3 text-midnight-500" />
