<script lang="ts">
  ...
  function generateSchema() {
    const orgSchema = {
      ...
      url: SITE_URL,
      description:
        "Authoritative profiles of legendary traders and investors. We document their strategies, philosophies, biographies, and timeless market wisdom.",
      logo: {
        "@type": "ImageObject",
    ...
    // June 2026: Named Person author for E-E-A-T (Organization author no longer sufficient)
    ...
    switch (type) {
      case "WebSite":
        return {
          ...
          url: SITE_URL,
          description:
            "Explore the minds that moved markets. Discover legendary traders, their strategies, and timeless wisdom from the greatest investors in history.",
      ...
      case "Person":
        ...
        return {
          ...
          description: trader.bio?.substring(0, 300) || trader.oneLiner,
          jobTitle: trader.tradingStyle
          ...
          sameAs:
            trader.socialLinks?.map((link: { url: string }) => link.url) || [],
        };
          ...
          breadcrumb: {
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Traders",
                item: `${SITE_URL}/traders`,
              },
              {
                "@type": "ListItem",
                position: 3,
                name: trader.name,
                item: `${SITE_URL}/traders/${trader.slug}`,
              },
            ],
          },
        };
      ...
      case "Article":
        ...
        return {
          ...
          description: trader.bio?.substring(0, 200),
          image: trader.photoUrl,
          // June 2026: Named Person author required for E-E-A-T signals
      ...
      case "TraderArticle":
        ...
        return {
          ...
          keywords:
            article.tags?.join(", ") || trader.tradingStyle || "trading",
          speakable: {
            "@type": "SpeakableSpecification",
            cssSelector: [
              "h1",
